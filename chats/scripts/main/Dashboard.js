class Dashboard {
    ...
    options() {
        ...
        this.container.querySelector(".navbar .home").onclick = () =>  window.location.href = "D:/TradinGo_WebPage/TradinGo.html";
        this.container.querySelector(".navbar .Add").onclick = () =>  window.location.href = "D:/TradinGo_WebPage/admin.html";
    }
